...
class Config:
    ...
    def from_env(cls) -> Config:
        ...
        env_map = {
            ...
            "SIA_POPULATION_SIZE": ("DEFAULT_POPULATION_SIZE", int),
            "SIA_ELITE_COUNT": ("DEFAULT_ELITE_COUNT", int),
            "SIA_MUTATION_RATE": ("DEFAULT_MUTATION_RATE", float),
