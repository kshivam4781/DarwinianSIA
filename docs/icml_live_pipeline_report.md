...
1. Portal Save Tick 32 uv-capable draft env `e0434bc7-…` (build `bld-20260806-5be244b4` SUCCEEDED) onto automation https://cursor.com/automations/bf73dff3-8f7a-11f1-a7d1-d6b4613131ce, then inject `ANTHROPIC_API_KEY` + `NEBIUS_API_KEY` + `HF_TOKEN` (accepted `Idavidrein/gpqa`).
2. Budget-check, then:
