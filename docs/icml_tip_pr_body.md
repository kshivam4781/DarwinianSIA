...
- Tick 418: merge `origin/main` into tip — resolve sole `README.md` path conflict (portable Windows `cd path\to\SIA2` + tip Linux/cloud `python3` block). Tip PR #337 is now **MERGEABLE/CLEAN** after push.
...
- [x] Tip branch contains `origin/main` merge commit; tip PR #337 **MERGEABLE/CLEAN**
