...
5. **Fitness lift:** preferred@gen2 mean − loser@gen1 mean = **+0.0576** (pop mean 0.252525 → 0.2919).
...
```json
{
  "run_dir": "/workspace/runs/run_1480",
  "field": "tool_strategy",
  ...
  "gen2_preferred_mean_fitness": 0.30146666666666666,
  "gen1_pop_mean": 0.252525,
  "gen2_pop_mean": 0.2919,
  "fitness_lift": 0.057566666666666655,
