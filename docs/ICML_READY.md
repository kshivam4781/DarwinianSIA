...
_Tick 405: dry-run writes resolved CABS feedback under delay-all (`run_1952`) and no longer stamps `prior_live_post` (G2→G3 poison). Live PRIMARY still blocked on NEBIUS + HF/CSV._
