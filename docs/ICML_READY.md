...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 202 env `31d13f14-…` (build `a18560b9` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
