...
_Tick 414: PRIMARY recompute on ledger-skip / pipeline resume (refuse false meta.primary_pass); always score H2 via planned_n. Tick 413 H5 planned-denominator VALIDITY. Live PRIMARY still blocked on NEBIUS + HF/CSV._
