...
_Tick 389: committed `docs/icml_prior_live_evidence.json` (cross-VM prior_live; budget-ledger parity); live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 389 note: Gate labels / secrets stack through Tick 389 committed prior_live evidence; live still blocked on NEBIUS+HF -->
