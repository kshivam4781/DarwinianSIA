...
_Tick 385: pipeline G3→G4 prior_live_metrics preserve landed; live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 385 note: Gate labels / secrets stack through Tick 385 prior_live_metrics; live still blocked on NEBIUS+HF -->
