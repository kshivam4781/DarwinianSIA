...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 229 env `31d13f14-…` (build `e1d81012` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
