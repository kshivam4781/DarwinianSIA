...
_Tick 411: G3 metrics require all planned pairs (not merely equal B/D counts) — closes partial pilot → G4 after mid-abort. Tick 410 G4 full-pair paper-pack gate. Tick 409 mid-G4 never-steer abort. Live PRIMARY still blocked on NEBIUS + HF/CSV._
