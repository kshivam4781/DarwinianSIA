...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 121 draft `0fe5bb37-…` (build `1a30bd18` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
