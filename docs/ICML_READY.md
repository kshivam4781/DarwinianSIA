...
_Tick 388: `icml_recover_tip.py --apply` prior_live stash parity landed; live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 388 note: Gate labels / secrets stack through Tick 388 recover_tip prior_live stash; live still blocked on NEBIUS+HF -->
