...
_Tick 399: judge-facing SUBMISSION/PRESENTATION/present_hackathon cite current offline IDs `1930–1944` / `run_1940` + H2 preferred **5/5**; restored `offline_bvd_summary.json` figures list; live PRIMARY still blocked on NEBIUS + HF/CSV._
