...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 251 env `31d13f14-…` (build `43427d67` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
