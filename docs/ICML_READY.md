...
_Tick 392: chicken-egg tip-apply without tip module (boot_recover/cron inline IGNORE); live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 392 note: Gate labels / secrets stack through Tick 392 chicken-egg tip-apply without tip module; live still blocked on NEBIUS+HF -->
