...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 165 draft `7af24780-…` (build `9e3b0eeb` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
