...
_Tick 391: tip-apply ignores gitignore-lag durables (boot/call/stash) so chicken-egg greenfield recover works; live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 391 note: Gate labels / secrets stack through Tick 391 tip-apply gitignore-lag durables; live still blocked on NEBIUS+HF -->
