...
_Tick 408: G4 post-checks refuse never-steer Condition D before paper pack / READY / ledger stamp (Tick 407 was G3→G4 only). Live PRIMARY still blocked on NEBIUS + HF/CSV._
