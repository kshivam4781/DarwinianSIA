...
_Tick 407: G3 post-checks prove Condition D delay-all *lifted* by gen≥3 (agenda in feedback). Complements Tick 406 fair-gen2 skip. Live PRIMARY still blocked on NEBIUS + HF/CSV._
