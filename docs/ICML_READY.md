...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 200 env `31d13f14-…` (build `2795fa6e` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
