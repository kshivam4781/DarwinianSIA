...
_Tick 390: tip-apply blocks dirty prior_live evidence (true budget-ledger parity); live PRIMARY still blocked on NEBIUS + HF/CSV._
...
<!-- Tick 390 note: Gate labels / secrets stack through Tick 390 tip-apply dirty evidence block; live still blocked on NEBIUS+HF -->
