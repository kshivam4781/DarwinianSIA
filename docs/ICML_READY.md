...
- Cursor env: `.cursor/environment.json` (+ **uv**) + Tick 155 draft `eab65d49-…` (build `363b76c4` SUCCEEDED + proposed; must Portal Save onto automation — prior drafts not inherited); pointer `docs/icml_portal_save_target.json`
