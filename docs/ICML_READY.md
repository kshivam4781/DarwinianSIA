...
_Tick 427: park/reinject G4 paper-pack companions across tip `--apply` (closes prepare refuse after mid-tick `apply_paper_pack`). Tick 426 co-commits companions post-live. Tip PR #337 remains **MERGEABLE/CLEAN**. Live PRIMARY still blocked on NEBIUS + HF/CSV._
