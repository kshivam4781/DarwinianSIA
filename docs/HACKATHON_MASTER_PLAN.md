...
**Last updated:** 2026-08-21 (Section 21 ICML; Tick 177 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 177: env `31d13f14-…` + build `bld-20260821-4427440f-…` **SUCCEEDED** + proposed (installs **uv** 0.12.5); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
