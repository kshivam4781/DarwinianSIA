...
**Last updated:** 2026-09-24 (Section 21 ICML; Tick 416 G4 ledger-skip exit 4 on Tick 413–415 refuse; Tick 415 thin H2 MECHANISM refuse; Tick 414 PRIMARY recompute; …)
...
| ICML thin H2 MECHANISM refuse on sidecar trust (Tick 415) | **DONE** | Refuse thin/false meta.h2_pass on ledger-skip/resume; READY needs primary+h5+h2 |
| ICML G4 ledger-skip exit 4 on Tick 413–415 refuse (Tick 416) | **DONE** | trust_refused includes h5/primary/h2 refuse checks; clear comparison; exit 4 not 0 |
| ICML B vs D multi-seed GPQA | **NOT DONE** | Blocked on NEBIUS + HF/CSV (Anthropic optional under Tick 289 meta); Tick 268–416 stack ready; next: secrets (+ optional merge tip→main / AGENTS bootstrap), then `bash scripts/icml_cron_entry.sh` |
