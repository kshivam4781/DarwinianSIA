...
**Last updated:** 2026-08-28 (Section 21 ICML; Tick 261 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 261: env `31d13f14-…` + build `bld-20260828-6ad37578-…` **SUCCEEDED** + proposed (installs **uv** 0.12.7); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
