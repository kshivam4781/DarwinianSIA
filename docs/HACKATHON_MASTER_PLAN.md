...
**Last updated:** 2026-08-28 (Section 21 ICML; Tick 252 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 252: env `31d13f14-…` + build `bld-20260828-d76f3afd-…` **SUCCEEDED** + proposed (installs **uv** 0.12.7); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
...
**Portal Save re-link (2026-08-28 Tick 252):** Cron again booted personal RUNTIME_FORWARD_FILL env `31d13f14-…` (Tick 251 not Portal Saved onto automation). Tick 251 build `43427d67` not proposable from this run; AGENT draft `bld-20260828-d76f3afd-34d4-49d2-b428-cc98928df1f8` **SUCCEEDED** (uv 0.12.7) + proposed; `docs/icml_portal_save_target.json` updated. User must Portal Save that env onto automation `bf73dff3-…` and inject secrets, or every future cron will keep re-creating orphan drafts.
