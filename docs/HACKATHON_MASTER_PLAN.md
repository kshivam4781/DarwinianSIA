...
**Last updated:** 2026-08-23 (Section 21 ICML; Tick 198 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 198: env `31d13f14-…` + build `bld-20260823-9b42d7fe-…` **SUCCEEDED** + proposed (installs **uv** 0.12.5); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
