...
**Last updated:** 2026-08-27 (Section 21 ICML; Tick 240 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 240: env `31d13f14-…` + build `bld-20260827-2bca4865-…` **SUCCEEDED** + proposed (installs **uv** 0.12.6); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
