...
**Last updated:** 2026-08-28 (Section 21 ICML; Tick 251 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 251: env `31d13f14-…` + build `bld-20260828-43427d67-…` **SUCCEEDED** + proposed (installs **uv** 0.12.7); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
