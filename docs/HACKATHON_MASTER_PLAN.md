...
**Last updated:** 2026-08-17 (Section 21 ICML; Tick 142 re-link uv Cursor env draft `5d2ea419` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 142: draft `5d2ea419-…` + build `bld-20260817-6a671495-…` **SUCCEEDED** + proposed (installs **uv** 0.12.5); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
