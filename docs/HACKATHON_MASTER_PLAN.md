...
**Last updated:** 2026-08-23 (Section 21 ICML; Tick 196 re-link uv Cursor env `31d13f14` + Portal Save target)  
...
| Cursor cloud environment (ICML live) | **PARTIAL** | Tick 196: env `31d13f14-…` + build `bld-20260823-6adcee0b-…` **SUCCEEDED** + proposed (installs **uv** 0.12.5); pointer `docs/icml_portal_save_target.json`; prior drafts not inherited — need Portal Save onto automation + secrets |
