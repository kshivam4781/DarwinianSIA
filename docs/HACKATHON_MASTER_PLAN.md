...
**Last updated:** 2026-09-06 (Section 21 ICML; Tick 357 reject short boot poison + checkout persist; Tick 356 boot-file gitignore + discard survive; Tick 355 cron no tip-boot-file clobber; Tick 354 false-boot ignore + persist; Tick 353 cron early boot-branch capture; Tick 352 cloud_boot_branch open_git_pr warn; Tick 351 anti-churn UNKNOWN mergeable; Tick 350 open_git_pr_call.json; Tick 349 open_git_pr_description inline; Tick 348 open_git_pr pass description; Tick 347 tip_pr_body_stale independent of title; Tick 346 tip PR body-file refresh; Tick 345 tip PR title edit commands; Tick 344 secrets-first open_git_pr title; Tick 343 PRIMARY-first human_next; Tick 342 AGENTS bootstrap PR in human_next; Tick 341 main-boot AGENTS chicken-egg bootstrap; Tick 340 open_git_pr never-omit-branch; Tick 339 tip recover --apply anti-churn checkout; Tick 338 cron tip PR anti-churn auto-checkout; Tick 337 tip PR anti-churn; Tick 336 tip PR gh copy-paste merge commands; Tick 335 tip PR mergeability in human_next; Tick 334 tip PR HEAD/local SHA fallback; Tick 333 same-SHA sibling tip PR fallback; Tick 332 HUMAN_UNBLOCK chicken-egg scans cursor/bc-*; Tick 331 tip lineage scans cursor/bc-*; Tick 330 concrete tip PR URL; Tick 329 cron full human_next; Tick 328 machine-readable dual unblock; Tick 327 dual human unblock; … Tick 268 secrets-first)  
...
| ICML B vs D multi-seed GPQA | **NOT DONE** | Blocked on NEBIUS + HF/CSV (Anthropic optional under Tick 289 meta); Tick 268–357 stack ready; next: secrets (+ optional merge tip→main / AGENTS bootstrap), then `bash scripts/icml_cron_entry.sh` |
