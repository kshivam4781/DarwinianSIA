...
**Timestamp:** 2026-08-31T14:07:51Z
**Mode:** `dry-run`
**Run ID:** `1856`
...
| `run_id_free` | yes | run_1856 unused |
...
```bash
/usr/bin/python3 -m sia run --task gpqa --darwinian --cabs --cabs-inline --population_size 2 --elite_count 1 --max_gen 2 --run_id 1856 --eval_subset 5 --no-web --seed 42 --dry-run --meta-agent-profile kimi-nebius-pydantic-meta --target-agent-profile kimi-nebius-target
```
...
| Check | OK | Detail |
|-------|----|--------|
| `run_dir` | yes | /workspace/SIA/runs/run_1856 |
| `belief_store` | yes | /workspace/SIA/runs/run_1856/belief_store |
